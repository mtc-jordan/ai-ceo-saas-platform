...
export default function Header() {
  ...
  const quickActions = [
    { label: 'New Meeting', icon: '📅', action: () => {} },
    { label: 'Create Report', icon: '📊', action: () => {} },
    { label: 'Ask AI', icon: '🤖', action: () => {} },
    { label: 'Add Goal', icon: '🎯', action: () => {} },
  ];
          ...
          <div className="relative">
            ...
            {showProfile && (
              <div className="absolute top-full right-0 mt-2 w-64 bg-slate-900 border border-slate-800 rounded-2xl shadow-2xl overflow-hidden">
                <div className="p-4 border-b border-slate-800">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-400">john@acmecorp.com</p>
                    </div>
                  </div>
                </div>
                <div className="p-2">
                  <Link to="/app/settings" className="flex items-center space-x-3 px-3 py-2 rounded-lg hover:bg-slate-800">
                    <span>👤</span>
                    <span className="text-sm text-slate-300">Profile Settings</span>
                  </Link>
                  <Link to="/app/billing" className="flex items-center space-x-3 px-3 py-2 rounded-lg hover:bg-slate-800">
                    <span>💳</span>
                ...
                <div className="p-2 border-t border-slate-800">
                  <button className="w-full flex items-center space-x-3 px-3 py-2 rounded-lg hover:bg-red-500/10 text-red-400">
                    <span>🚪</span>
